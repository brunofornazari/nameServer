...
public class appExpenseServer {
    ...
    public static void main(String[] args) {
        try {
            ...
            expenseServerImpl avgServer = new expenseServerImpl();
            ...
            ServidorIndividual _servico = new ServidorIndividual("MostraDespesas", "rmi://localhost:1099/Expense");
